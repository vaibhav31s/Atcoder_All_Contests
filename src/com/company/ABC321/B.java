...
public class B {
    public static void main(String[] args) {
        ...
        for(int i = 0; i <= 100; i++) {
            ...
            int curSum = 0;
            Integer lowerKey = map.firstKey();
            Integer higherKey = map.lastKey();
            curSum +=   lowerKey * (map.get(lowerKey) - 1);
            curSum +=   higherKey * (map.get(higherKey) - 1);
            for(Integer k :  map.keySet()) {
                if(Objects.equals(k, lowerKey) || Objects.equals(k, higherKey)) continue;
