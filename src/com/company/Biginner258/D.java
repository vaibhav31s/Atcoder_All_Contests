package com.company.Biginner258;
...
public class D {
    public static void main(String[] args) {
       ...
       ArrayList<ArrayList<Long>> map = new ArrayList<>();
        HashMap<String, ArrayList<Integer>> alist = new HashMap<>();

//       boolean ans = issCycle(alist);
//        ArrayList<ArrayList<Integer>> adj = new ArrayList<>();
//       if(ans) out.println("No");
//        else out.println("Yes");

    }
private static void createAList(ArrayList<ArrayList<Long>> vai, HashMap<Long, ArrayList<Long>> graph) {
    for(ArrayList<Long> ss : vai) {
        Long a = ss.get(0);
        Long b = ss.get(1);
...
private static boolean issCycle(HashMap<Integer, ArrayList<Integer>> graph) {
...
return false;
    ...
    private static boolean isCycle(Integer cur, HashMap<Integer, ArrayList<Integer>> graph, HashSet<Integer> vis, Integer parent) {
        vis.add(cur);
