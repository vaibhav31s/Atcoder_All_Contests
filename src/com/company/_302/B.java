...
public class B {
    static String s = "snuke";
    static String se = "ekuns";
            ...
            for(int j = 0; j < m; j++){
                if(arr[i][j] == 's' || arr[i][j] == 'e'){
                    if(i+4 < n){
                        ...
                        String ss = String.valueOf(a+""+b+""+c+""+d+""+e);
                        if(ss.equals(s)){
                            out.println(i + " " + j);
                            out.println((i+ 1)+ " " + j);
                            out.println((i+2) + " " + j);
                            out.println((i+3) + " " + j);
                            out.println((i+4) + " " + j);return;
                        }else if(ss.equals(se)){
                            out.println((i+4) + " " + j);  out.println((i+3) + " " + j); out.println((i+2) + " " + j);   out.println((i+ 1)+ " " + j);  out.println(i + " " + j);
                      return;
                        }
...
//                        out.println(ss);
                        if(ss.equals(s)){
                            ...
                            out.println(i + " " + (j+2));
                            out.println(i + " " + (j+3));
                            out.println(i + " " + (j+4));return;

                        }else if(ss.equals(se)){
                            out.println(i + " " + (j+4));out.println(i + " " + (j+3));
                            out.println(i + " " + (j+2));
                            out.println(i + " " + (j+1));
                            out.println(i + " " + j);return;
                        }
...
//                        out.println(ss);
                        if(ss.equals(s)){
                            ...
                            out.println((i+2) + " " + (j+2));
                            out.println((i+3) + " " + (j+3));
                            out.println((i+4) + " " + (j+4));return;

                        }else if(ss.equals(se)){
                            out.println((i+4) + " " + (j+4));
                            out.println((i+3) + " " + (j+3));
                            out.println((i+2) + " " + (j+2));
                            out.println((i+1) + " " + (j+1));out.println(i + " " + j);return;
                        }
                    }
                    else if(i - 4 >= 0 && j - 4 >= 0){
                        char a = arr[i][j];
