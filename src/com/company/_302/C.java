...
public class C {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < n; i++){
            for(int j = i + 1; j <n; j++){
                if(dif(strings.get(i), strings.get(j))){
                    list.putIfAbsent(strings.get(i), new ArrayList<>());
                    list.get(strings.get(i)).add(strings.get(j));
                }
            }
        }
    ...
    private static boolean dif(String s, String s1) {
        boolean flag = false;
