...
public class B {
    public static void main(String[] args) {
        ...
        int h = sc.nextInt();
        int w = sc.nextInt();
        char[][] first = new char[h][w];
        for(int i = 0; i < h; i++){
            first[i] = readarr(sc, w);
        }
        char[][] second = new char[h][w];
        for(int i = 0; i < h; i++){
            second[i] = readarr(sc, w);
        }


    }

    private static char[] readarr(FastScanner sc, int n) {
        char[] arr = new char[n];
        for (int i = 0; i < n; i++) arr[i] = sc.getChar();
